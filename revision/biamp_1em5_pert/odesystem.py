...
def odesystem(p0, t0, r):
    Cj, Ck, shCj, shCk, B12, B16, B21, B22, B27, B35, B41, BS18, BS19, BS24, BS32, BS39, BS44, BS9, BackCB, Br, HelperCCk, O1, O2, ProduceBCjCk, ReactCBCj, shBackCB, shBr, shHelperCCk, shProduceBCjCk, shReactCBCj = p0
    if not r : r = rates


    dCjdt = 1.0e-5*B12*BackCB + 1.0e-5*B21*ProduceBCjCk - 1.0e-5*B27*Cj - 8.0e-6*Cj*ReactCBCj
    dCkdt = 1.0e-5*B16*BackCB + 1.0e-5*B27*HelperCCk - 8.0e-6*Ck*ReactCBCj + 2.0e-8*HelperCCk*ProduceBCjCk
    dshCjdt = 1.0e-5*BS18*shProduceBCjCk - 1.0e-5*BS24*shCj + 1.0e-5*BS39*shBackCB - 8.0e-6*shCj*shReactCBCj
    dshCkdt = 1.0e-5*BS24*shHelperCCk + 1.0e-5*BS9*shBackCB - 8.0e-6*shCk*shReactCBCj + 1.0e-8*shHelperCCk*shProduceBCjCk
    ...
    dshHelperCCkdt = -1.0e-5*BS24*shHelperCCk - 1.0e-8*shHelperCCk*shProduceBCjCk
    dshProduceBCjCkdt = -1.0e-5*BS18*shProduceBCjCk + 1.0e-5*BS24*shCj - 1.0e-8*shHelperCCk*shProduceBCjCk
    dshReactCBCjdt = 1.0e-5*BS39*shBackCB + 1.0e-5*BS9*shBackCB - 8.0e-6*shCj*shReactCBCj - 8.0e-6*shCk*shReactCBCj
    return np.array([dCjdt, dCkdt, dshCjdt, dshCkdt, dB12dt, dB16dt, dB21dt, dB22dt, dB27dt, dB35dt, dB41dt, dBS18dt, dBS19dt, dBS24dt, dBS32dt, dBS39dt, dBS44dt, dBS9dt, dBackCBdt, dBrdt, dHelperCCkdt, dO1dt, dO2dt, dProduceBCjCkdt, dReactCBCjdt, dshBackCBdt, dshBrdt, dshHelperCCkdt, dshProduceBCjCkdt, dshReactCBCjdt])
...
def jacobian(p0, t0, r):
    ...
    J[1][18] = 1.0e-5*B16
    J[1][19] = 0
    J[1][20] = 1.0e-5*B27 + 2.0e-8*ProduceBCjCk
    J[1][21] = 0
    J[1][22] = 0
    J[1][23] = 2.0e-8*HelperCCk
    J[1][24] = -8.0e-6*Ck
    J[1][25] = 0
    J[1][26] = 0
    J[1][27] = 0
    ...
    J[2][9] = 0
    J[2][10] = 0
    J[2][11] = 1.0e-5*shProduceBCjCk
    J[2][12] = 0
    J[2][13] = -1.0e-5*shCj
    J[2][14] = 0
    J[2][15] = 1.0e-5*shBackCB
    J[2][16] = 0
    J[2][17] = 0
    J[2][18] = 0
    J[2][19] = 0
    ...
    J[3][11] = 0
    J[3][12] = 0
    J[3][13] = 1.0e-5*shHelperCCk
    J[3][14] = 0
    J[3][15] = 0
    J[3][16] = 0
    J[3][17] = 1.0e-5*shBackCB
    J[3][18] = 0
    J[3][19] = 0
    J[3][20] = 0
    J[3][21] = 0
    ...
    J[3][25] = 1.0e-5*BS9
    J[3][26] = 0
    J[3][27] = 1.0e-5*BS24 + 1.0e-8*shProduceBCjCk
    J[3][28] = 1.0e-8*shHelperCCk
    J[3][29] = -8.0e-6*shCk
    J[4][0] = 8.0e-6*ReactCBCj
    J[4][1] = 0
    J[4][2] = 0
    J[4][3] = 0
    J[4][4] = -1.0e-5*BackCB - 1.0e-5*Br
    J[4][5] = 0
    J[4][6] = 0
    J[4][7] = 0
    J[4][8] = 0
    ...
    J[8][4] = 0
    J[8][5] = 0
    J[8][6] = 1.0e-5*ProduceBCjCk
    J[8][7] = 0
    J[8][8] = -1.0e-5*Cj - 1.0e-5*HelperCCk
    J[8][9] = 0
    J[8][10] = 0
    J[8][11] = 0
    J[8][12] = 0
    ...
    J[11][24] = 0
    J[11][25] = 0
    J[11][26] = 1.0e-5*BS39 + 1.0e-5*BS9
    J[11][27] = 0
    J[11][28] = -1.0e-5*BS18
    J[11][29] = 0
    J[12][0] = 0
    ...
    J[13][9] = 0
    J[13][10] = 0
    J[13][11] = 1.0e-5*shProduceBCjCk
    J[13][12] = 0
    J[13][13] = -1.0e-5*shCj - 1.0e-5*shHelperCCk
    J[13][14] = 0
    J[13][15] = 0
    J[13][16] = 0
    J[13][17] = 0
    ...
    J[15][13] = 0
    J[15][14] = 0
    J[15][15] = -1.0e-5*shBackCB - 1.0e-5*shBr
    J[15][16] = 0
    J[15][17] = 0
    J[15][18] = 0
    J[15][19] = 0
    ...
    J[18][2] = 0
    J[18][3] = 0
    J[18][4] = -1.0e-5*BackCB
    J[18][5] = -1.0e-5*BackCB
    J[18][6] = 0
    J[18][7] = 0
    J[18][8] = 0
    J[18][9] = 0
    ...
    J[18][16] = 0
    J[18][17] = 0
    J[18][18] = -1.0e-5*B12 - 1.0e-5*B16
    J[18][19] = 0
    J[18][20] = 0
    J[18][21] = 0
    J[18][22] = 0
    J[18][23] = 0
    J[18][24] = 8.0e-6*Cj + 8.0e-6*Ck
    J[18][25] = 0
    J[18][26] = 0
    J[18][27] = 0
    J[18][28] = 0
    ...
    J[20][18] = 0
    J[20][19] = 0
    J[20][20] = -1.0e-5*B27 - 2.0e-8*ProduceBCjCk
    J[20][21] = 0
    J[20][22] = 0
    J[20][23] = -2.0e-8*HelperCCk
    J[20][24] = 0
    J[20][25] = 0
    J[20][26] = 0
    J[20][27] = 0
    ...
    J[23][18] = 0
    J[23][19] = 0
    J[23][20] = -2.0e-8*ProduceBCjCk
    J[23][21] = 0
    J[23][22] = 0
    J[23][23] = -1.0e-5*B21 - 2.0e-8*HelperCCk
    J[23][24] = 0
    J[23][25] = 0
    J[23][26] = 0
    J[23][27] = 0
    J[23][28] = 0
    J[23][29] = 0
    J[24][0] = -8.0e-6*ReactCBCj
    J[24][1] = -8.0e-6*ReactCBCj
    J[24][2] = 0
    J[24][3] = 0
    J[24][4] = 1.0e-5*BackCB
    J[24][5] = 1.0e-5*BackCB
    J[24][6] = 0
    J[24][7] = 0
    J[24][8] = 0
    J[24][9] = 0
    ...
    J[24][16] = 0
    J[24][17] = 0
    J[24][18] = 1.0e-5*B12 + 1.0e-5*B16
    J[24][19] = 0
    J[24][20] = 0
    J[24][21] = 0
    J[24][22] = 0
    J[24][23] = 0
    J[24][24] = -8.0e-6*Cj - 8.0e-6*Ck
    J[24][25] = 0
    J[24][26] = 0
    J[24][27] = 0
    J[24][28] = 0
    ...
    J[25][13] = 0
    J[25][14] = 0
    J[25][15] = -1.0e-5*shBackCB
    J[25][16] = 0
    J[25][17] = -1.0e-5*shBackCB
    J[25][18] = 0
    J[25][19] = 0
    J[25][20] = 0
    J[25][21] = 0
    ...
    J[25][23] = 0
    J[25][24] = 0
    J[25][25] = -1.0e-5*BS39 - 1.0e-5*BS9
    J[25][26] = 0
    J[25][27] = 0
    J[25][28] = 0
    J[25][29] = 8.0e-6*shCj + 8.0e-6*shCk
    J[26][0] = 0
    J[26][1] = 0
    J[26][2] = 0
    J[26][3] = 0
    ...
    J[27][25] = 0
    J[27][26] = 0
    J[27][27] = -1.0e-5*BS24 - 1.0e-8*shProduceBCjCk
    J[27][28] = -1.0e-8*shHelperCCk
    J[27][29] = 0
    J[28][0] = 0
    J[28][1] = 0
    J[28][2] = 1.0e-5*BS24
    ...
    J[28][25] = 0
    J[28][26] = 0
    J[28][27] = -1.0e-8*shProduceBCjCk
    J[28][28] = -1.0e-5*BS18 - 1.0e-8*shHelperCCk
    J[28][29] = 0
    J[29][0] = 0
    J[29][1] = 0
    ...
    J[29][23] = 0
    J[29][24] = 0
    J[29][25] = 1.0e-5*BS39 + 1.0e-5*BS9
    J[29][26] = 0
    J[29][27] = 0
    J[29][28] = 0
...
def integrate(args, setlogger = False):
    ...
    svars = ["Cj", "Ck", "shCj", "shCk", "B12", "B16", "B21", "B22", "B27", "B35", "B41", "BS18", "BS19", "BS24", "BS32", "BS39", "BS44", "BS9", "BackCB", "Br", "HelperCCk", "O1", "O2", "ProduceBCjCk", "ReactCBCj", "shBackCB", "shBr", "shHelperCCk", "shProduceBCjCk", "shReactCBCj"]
