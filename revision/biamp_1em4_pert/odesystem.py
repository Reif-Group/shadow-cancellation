...
def odesystem(p0, t0, r):
    Cj, Ck, shCj, shCk, Br, shBr, CancelC, B12, B16, B21, B22, B27, B35, B41, BS18, BS19, BS24, BS32, BS39, BS44, BS9, BackCB, EC19, EC28, EC3, EC42, EC52, EC6, EC64, EC8, HelperCCk, O1, O2, ProduceBCjCk, ReactCBCj, dispC, shBackCB, shHelperCCk, shProduceBCjCk, shReactCBCj = p0
    if not r : r = rates


    dCjdt = 0.0001*B12*BackCB + 0.0001*B21*ProduceBCjCk - 0.0001*B27*Cj - 0.004*CancelC*Cj - 0.004*Cj*EC3 - 0.004*Cj*EC6 - 8.0e-5*Cj*ReactCBCj + 0.3*EC42
    dCkdt = 0.0001*B16*BackCB + 0.0001*B27*HelperCCk - 0.004*CancelC*Ck - 0.004*Ck*EC3 - 0.004*Ck*EC6 - 8.0e-5*Ck*ReactCBCj + 0.3*EC8 + 1.0e-8*HelperCCk*ProduceBCjCk
    dshCjdt = 0.0001*BS18*shProduceBCjCk - 0.0001*BS24*shCj + 0.0001*BS39*shBackCB - 0.004*CancelC*shCj - 0.004*EC42*shCj + 0.3*EC6 - 0.004*EC8*shCj - 8.0e-5*shCj*shReactCBCj
    dshCkdt = 0.0001*BS24*shHelperCCk + 0.0001*BS9*shBackCB - 0.004*CancelC*shCk + 0.3*EC3 - 0.004*EC42*shCk - 0.004*EC8*shCk - 8.0e-5*shCk*shReactCBCj + 8.0e-8*shHelperCCk*shProduceBCjCk
    dBrdt = -0.0001*B12*Br - 0.0001*B16*Br
    dshBrdt = -0.0001*BS39*shBr - 0.0001*BS9*shBr
    dCancelCdt = -0.004*CancelC*Cj - 0.004*CancelC*Ck - 0.004*CancelC*shCj - 0.004*CancelC*shCk + 0.3*EC3 + 0.3*EC42 + 0.3*EC6 + 0.3*EC8
    ...
    dB35dt = 0.0001*B27*HelperCCk
    dB41dt = 0.0001*B12*Br
    dBS18dt = -0.0001*BS18*shProduceBCjCk + 0.0001*BS24*shCj + 0.0001*BS39*shBr + 0.0001*BS9*shBr
    dBS19dt = 0.0001*BS9*shBr
    dBS24dt = 0.0001*BS18*shProduceBCjCk - 0.0001*BS24*shCj - 0.0001*BS24*shHelperCCk
    dBS32dt = 0.0001*BS24*shHelperCCk
    dBS39dt = -0.0001*BS39*shBackCB - 0.0001*BS39*shBr + 8.0e-5*shCj*shReactCBCj
    dBS44dt = 0.0001*BS39*shBr
    dBS9dt = -0.0001*BS9*shBackCB - 0.0001*BS9*shBr + 8.0e-5*shCk*shReactCBCj
    ...
    dHelperCCkdt = -0.0001*B27*HelperCCk - 1.0e-8*HelperCCk*ProduceBCjCk
    dO1dt = 2.2e-5*O1*O2
    dO2dt = -2.2e-5*O1*O2
    dProduceBCjCkdt = -0.0001*B21*ProduceBCjCk + 0.0001*B27*Cj - 1.0e-8*HelperCCk*ProduceBCjCk
    ...
    dshBackCBdt = -0.0001*BS39*shBackCB - 0.0001*BS9*shBackCB + 8.0e-5*shCj*shReactCBCj + 8.0e-5*shCk*shReactCBCj
    dshHelperCCkdt = -0.0001*BS24*shHelperCCk - 8.0e-8*shHelperCCk*shProduceBCjCk
    dshProduceBCjCkdt = -0.0001*BS18*shProduceBCjCk + 0.0001*BS24*shCj - 8.0e-8*shHelperCCk*shProduceBCjCk
    dshReactCBCjdt = 0.0001*BS39*shBackCB + 0.0001*BS9*shBackCB - 8.0e-5*shCj*shReactCBCj - 8.0e-5*shCk*shReactCBCj
    return np.array([dCjdt, dCkdt, dshCjdt, dshCkdt, dBrdt, dshBrdt, dCancelCdt, dB12dt, dB16dt, dB21dt, dB22dt, dB27dt, dB35dt, dB41dt, dBS18dt, dBS19dt, dBS24dt, dBS32dt, dBS39dt, dBS44dt, dBS9dt, dBackCBdt, dEC19dt, dEC28dt, dEC3dt, dEC42dt, dEC52dt, dEC6dt, dEC64dt, dEC8dt, dHelperCCkdt, dO1dt, dO2dt, dProduceBCjCkdt, dReactCBCjdt, ddispCdt, dshBackCBdt, dshHelperCCkdt, dshProduceBCjCkdt, dshReactCBCjdt])
...
def jacobian(p0, t0, r):
    ...
    J[0][0] = -0.0001*B27 - 0.004*CancelC - 0.004*EC3 - 0.004*EC6 - 8.0e-5*ReactCBCj
    J[0][1] = 0
    J[0][2] = 0
    J[0][3] = 0
    J[0][4] = 0
    ...
    J[0][39] = 0
    J[1][0] = 0
    J[1][1] = -0.004*CancelC - 0.004*EC3 - 0.004*EC6 - 8.0e-5*ReactCBCj
    J[1][2] = 0
    J[1][3] = 0
    J[1][4] = 0
    J[1][5] = 0
    ...
    J[1][30] = 0.0001*B27 + 1.0e-8*ProduceBCjCk
    J[1][31] = 0
    J[1][32] = 0
    ...
    J[2][0] = 0
    J[2][1] = 0
    J[2][2] = -0.0001*BS24 - 0.004*CancelC - 0.004*EC42 - 0.004*EC8 - 8.0e-5*shReactCBCj
    J[2][3] = 0
    J[2][4] = 0
    J[2][5] = 0
    J[2][6] = -0.004*shCj
    ...
    J[2][12] = 0
    J[2][13] = 0
    J[2][14] = 0.0001*shProduceBCjCk
    J[2][15] = 0
    J[2][16] = -0.0001*shCj
    J[2][17] = 0
    J[2][18] = 0.0001*shBackCB
    J[2][19] = 0
    J[2][20] = 0
    J[2][21] = 0
    J[2][22] = 0
    ...
    J[3][1] = 0
    J[3][2] = 0
    J[3][3] = -0.004*CancelC - 0.004*EC42 - 0.004*EC8 - 8.0e-5*shReactCBCj
    J[3][4] = 0
    J[3][5] = 0
    J[3][6] = -0.004*shCk
    J[3][7] = 0
    ...
    J[3][14] = 0
    J[3][15] = 0
    J[3][16] = 0.0001*shHelperCCk
    J[3][17] = 0
    J[3][18] = 0
    J[3][19] = 0
    J[3][20] = 0.0001*shBackCB
    J[3][21] = 0
    J[3][22] = 0
    J[3][23] = 0
    J[3][24] = 0.300000000000000
    J[3][25] = -0.004*shCk
    J[3][26] = 0
    J[3][27] = 0
    J[3][28] = 0
    ...
    J[3][35] = 0
    J[3][36] = 0.0001*BS9
    J[3][37] = 0.0001*BS24 + 8.0e-8*shProduceBCjCk
    J[3][38] = 8.0e-8*shHelperCCk
    J[3][39] = -8.0e-5*shCk
    J[4][0] = 0
    J[4][1] = 0
    J[4][2] = 0
    J[4][3] = 0
    J[4][4] = -0.0001*B12 - 0.0001*B16
    J[4][5] = 0
    J[4][6] = 0
    J[4][7] = -0.0001*Br
    J[4][8] = -0.0001*Br
    ...
    J[6][4] = 0
    J[34][8] = 0.0001*BackCB
    J[34][9] = 0
    J[34][10] = 0
    J[34][11] = 0
    J[34][12] = 0
    ...
    J[34][32] = 0
    J[34][33] = 0
    J[34][34] = -8.0e-5*Cj - 8.0e-5*Ck
    J[34][35] = 0
    J[34][36] = 0
    J[34][37] = 0
    J[34][38] = 0
    J[34][39] = 0
    J[35][0] = 0.004*EC3 + 0.004*EC6
    J[35][1] = 0.004*EC3 + 0.004*EC6
    J[35][2] = 0.004*EC42 + 0.004*EC8
    J[35][3] = 0.004*EC42 + 0.004*EC8
    J[35][4] = 0
    J[35][5] = 0
    J[35][6] = 0
    J[35][7] = 0
    ...
    J[35][22] = 0
    J[35][23] = 0
    J[35][24] = 0.004*Cj + 0.004*Ck
    J[35][25] = 0.004*shCj + 0.004*shCk
    J[35][26] = 0
    J[35][27] = 0.004*Cj + 0.004*Ck
    J[35][28] = 0
    J[35][29] = 0.004*shCj + 0.004*shCk
    J[35][30] = 0
    J[35][31] = 0
    J[35][32] = 0
    J[35][33] = 0
    ...
    J[36][0] = 0
    J[36][1] = 0
    J[36][2] = 8.0e-5*shReactCBCj
    J[36][3] = 8.0e-5*shReactCBCj
    J[36][4] = 0
    J[36][5] = 0
    J[36][6] = 0
    J[36][7] = 0
    ...
    J[36][16] = 0
    J[36][17] = 0
    J[36][18] = -0.0001*shBackCB
    J[36][19] = 0
    J[36][20] = -0.0001*shBackCB
    J[36][21] = 0
    J[36][22] = 0
    J[36][23] = 0
    J[36][24] = 0
    ...
    J[36][34] = 0
    J[36][35] = 0
    J[36][36] = -0.0001*BS39 - 0.0001*BS9
    J[36][37] = 0
    J[36][38] = 0
    J[36][39] = 8.0e-5*shCj + 8.0e-5*shCk
    J[37][0] = 0
    J[37][1] = 0
    J[37][2] = 0
    J[37][3] = 0
    ...
    J[37][35] = 0
    J[37][36] = 0
    J[37][37] = -0.0001*BS24 - 8.0e-8*shProduceBCjCk
    ...
    J[38][38] = -0.0001*BS18 - 8.0e-8*shHelperCCk
    J[38][39] = 0
    J[39][0] = 0
    J[39][1] = 0
    J[39][2] = -8.0e-5*shReactCBCj
    J[39][3] = -8.0e-5*shReactCBCj
    J[39][4] = 0
    J[39][5] = 0
    J[39][6] = 0
    J[39][7] = 0
    ...
    J[39][16] = 0
    J[39][17] = 0
    J[39][18] = 0.0001*shBackCB
    J[39][19] = 0
    J[39][20] = 0.0001*shBackCB
    J[39][21] = 0
    J[39][22] = 0
    J[39][23] = 0
    J[39][24] = 0
    ...
    J[39][34] = 0
    J[39][35] = 0
    J[39][36] = 0.0001*BS39 + 0.0001*BS9
    J[39][37] = 0
    J[39][38] = 0
    J[39][39] = -8.0e-5*shCj - 8.0e-5*shCk
    return J
...
def integrate(args, setlogger = False):
    ...
    svars = ["Cj", "Ck", "shCj", "shCk", "Br", "shBr", "CancelC", "B12", "B16", "B21", "B22", "B27", "B35", "B41", "BS18", "BS19", "BS24", "BS32", "BS39", "BS44", "BS9", "BackCB", "EC19", "EC28", "EC3", "EC42", "EC52", "EC6", "EC64", "EC8", "HelperCCk", "O1", "O2", "ProduceBCjCk", "ReactCBCj", "dispC", "shBackCB", "shHelperCCk", "shProduceBCjCk", "shReactCBCj"]
