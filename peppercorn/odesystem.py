...
def odesystem(p0, t0, r):
    Cj, Br, shCj, shBr, B12, B21, B27, B35, B41, BS18, BS24, BS32, BS39, BS44, BackCB, CancelC, EC42, EC52, EC6, HelperCCj, O1, O2, ProduceBCjCj, ReactCBCj, dispC, shBackCB, shHelperCCj, shProduceBCjCj, shReactCBCj = p0
    if not r : r = rates


    dCjdt = 0.0002*B12*BackCB + 0.0003*B21*ProduceBCjCj - 5.0e-5*B27*Cj + 0.0005*B27*HelperCCj - 0.00041*CancelC*Cj - 0.0041*Cj*EC6 - 1.6e-5*Cj*ReactCBCj + 0.3*EC42 + 2.0e-8*HelperCCj*ProduceBCjCj
    dBrdt = -6.0e-5*B12*Br
    dshCjdt = 0.0016*BS18*shProduceBCjCj - 0.00024*BS24*shCj + 0.0026*BS24*shHelperCCj + 0.001*BS39*shBackCB - 0.0041*CancelC*shCj - 0.0041*EC42*shCj + 0.2*EC6 - 8.6e-5*shCj*shReactCBCj + 2.0e-8*shHelperCCj*shProduceBCjCj
    dshBrdt = -0.0003*BS39*shBr
    dB12dt = -0.0002*B12*BackCB - 6.0e-5*B12*Br + 1.6e-5*Cj*ReactCBCj
    dB21dt = 6.0e-5*B12*Br - 0.0003*B21*ProduceBCjCj + 5.0e-5*B27*Cj
    dB27dt = 0.0003*B21*ProduceBCjCj - 5.0e-5*B27*Cj - 0.0005*B27*HelperCCj
    dB35dt = 0.0005*B27*HelperCCj
    dB41dt = 6.0e-5*B12*Br
    dBS18dt = -0.0016*BS18*shProduceBCjCj + 0.00024*BS24*shCj + 0.0003*BS39*shBr
    dBS24dt = 0.0016*BS18*shProduceBCjCj - 0.00024*BS24*shCj - 0.0026*BS24*shHelperCCj
    dBS32dt = 0.0026*BS24*shHelperCCj
    dBS39dt = -0.001*BS39*shBackCB - 0.0003*BS39*shBr + 8.6e-5*shCj*shReactCBCj
    dBS44dt = 0.0003*BS39*shBr
    dBackCBdt = -0.0002*B12*BackCB + 1.6e-5*Cj*ReactCBCj
    dCancelCdt = -0.00041*CancelC*Cj - 0.0041*CancelC*shCj + 0.3*EC42 + 0.2*EC6
    dEC42dt = 0.00041*CancelC*Cj - 0.0041*EC42*shCj - 0.3*EC42
    dEC52dt = 0.0041*Cj*EC6 + 0.0041*EC42*shCj
    dEC6dt = 0.0041*CancelC*shCj - 0.0041*Cj*EC6 - 0.2*EC6
    dHelperCCjdt = -0.0005*B27*HelperCCj - 2.0e-8*HelperCCj*ProduceBCjCj
    dO1dt = 2.2e-5*O1*O2
    dO2dt = -2.2e-5*O1*O2
    dProduceBCjCjdt = -0.0003*B21*ProduceBCjCj + 5.0e-5*B27*Cj - 2.0e-8*HelperCCj*ProduceBCjCj
    dReactCBCjdt = 0.0002*B12*BackCB - 1.6e-5*Cj*ReactCBCj
    ddispCdt = 0.0041*Cj*EC6 + 0.0041*EC42*shCj
    dshBackCBdt = -0.001*BS39*shBackCB + 8.6e-5*shCj*shReactCBCj
    dshHelperCCjdt = -0.0026*BS24*shHelperCCj - 2.0e-8*shHelperCCj*shProduceBCjCj
    dshProduceBCjCjdt = -0.0016*BS18*shProduceBCjCj + 0.00024*BS24*shCj - 2.0e-8*shHelperCCj*shProduceBCjCj
    dshReactCBCjdt = 0.001*BS39*shBackCB - 8.6e-5*shCj*shReactCBCj
    return np.array([dCjdt, dBrdt, dshCjdt, dshBrdt, dB12dt, dB21dt, dB27dt, dB35dt, dB41dt, dBS18dt, dBS24dt, dBS32dt, dBS39dt, dBS44dt, dBackCBdt, dCancelCdt, dEC42dt, dEC52dt, dEC6dt, dHelperCCjdt, dO1dt, dO2dt, dProduceBCjCjdt, dReactCBCjdt, ddispCdt, dshBackCBdt, dshHelperCCjdt, dshProduceBCjCjdt, dshReactCBCjdt])
...
def jacobian(p0, t0, r):
    ...
    J[0][0] = -5.0e-5*B27 - 0.00041*CancelC - 0.0041*EC6 - 1.6e-5*ReactCBCj
    J[0][1] = 0
    J[0][2] = 0
    J[0][3] = 0
    J[0][4] = 0.0002*BackCB
    J[0][5] = 0.0003*ProduceBCjCj
    J[0][6] = -5.0e-5*Cj + 0.0005*HelperCCj
    J[0][7] = 0
    J[0][8] = 0
    J[0][9] = 0
    J[0][10] = 0
    ...
    J[0][14] = 0.0002*B12
    J[0][15] = -0.00041*Cj
    J[0][16] = 0.300000000000000
    J[0][17] = 0
    J[0][18] = -0.0041*Cj
    J[0][19] = 0.0005*B27 + 2.0e-8*ProduceBCjCj
    J[0][20] = 0
    J[0][21] = 0
    J[0][22] = 0.0003*B21 + 2.0e-8*HelperCCj
    J[0][23] = -1.6e-5*Cj
    J[0][24] = 0
    J[0][25] = 0
    J[0][26] = 0
    ...
    J[2][0] = 0
    J[2][1] = 0
    J[2][2] = -0.00024*BS24 - 0.0041*CancelC - 0.0041*EC42 - 8.6e-5*shReactCBCj
    J[2][3] = 0
    J[2][4] = 0
    J[2][5] = 0
    J[2][6] = 0
    J[2][7] = 0
    J[2][8] = 0
    J[2][9] = 0.0016*shProduceBCjCj
    J[2][10] = -0.00024*shCj + 0.0026*shHelperCCj
    J[2][11] = 0
    J[2][12] = 0.001*shBackCB
    J[2][13] = 0
    J[2][14] = 0
    J[2][15] = -0.0041*shCj
    J[2][16] = -0.0041*shCj
    J[2][17] = 0
    J[2][18] = 0.200000000000000
    J[2][19] = 0
    J[2][20] = 0
    J[2][21] = 0
    J[2][22] = 0
    ...
    J[2][24] = 0
    J[2][25] = 0.001*BS39
    J[2][26] = 0.0026*BS24 + 2.0e-8*shProduceBCjCj
    J[2][27] = 0.0016*BS18 + 2.0e-8*shHelperCCj
    J[2][28] = -8.6e-5*shCj
    J[3][0] = 0
    J[3][1] = 0
    J[3][2] = 0
    ...
    J[3][27] = 0
    J[3][28] = 0
    J[4][0] = 1.6e-5*ReactCBCj
    J[4][1] = -6.0e-5*B12
    J[4][2] = 0
    J[4][3] = 0
    J[4][4] = -0.0002*BackCB - 6.0e-5*Br
    J[4][5] = 0
    J[4][6] = 0
    J[4][7] = 0
    J[4][8] = 0
    ...
    J[6][3] = 0
    J[6][4] = 0
    J[6][5] = 0.0003*ProduceBCjCj
    J[6][6] = -5.0e-5*Cj - 0.0005*HelperCCj
    J[6][7] = 0
    J[6][8] = 0
    J[6][9] = 0
    J[6][10] = 0
    ...
    J[10][7] = 0
    J[10][8] = 0
    J[10][9] = 0.0016*shProduceBCjCj
    J[10][10] = -0.00024*shCj - 0.0026*shHelperCCj
    J[10][11] = 0
    J[10][12] = 0
    J[10][13] = 0
    J[10][14] = 0
    ...
    J[12][10] = 0
    J[12][11] = 0
    J[12][12] = -0.001*shBackCB - 0.0003*shBr
    J[12][13] = 0
    J[12][14] = 0
    J[12][15] = 0
    J[12][16] = 0
    ...
    J[13][27] = 0
    J[13][28] = 0
    J[14][0] = 1.6e-5*ReactCBCj
    J[14][1] = 0
    J[14][2] = 0
    J[14][3] = 0
    J[14][4] = -0.0002*BackCB
    J[14][5] = 0
    J[14][6] = 0
    J[14][7] = 0
    J[14][8] = 0
    ...
    J[14][27] = 0
    J[14][28] = 0
    J[15][0] = -0.00041*CancelC
    J[15][1] = 0
    J[15][2] = -0.0041*CancelC
    J[15][3] = 0
    J[15][4] = 0
    J[15][5] = 0
    J[15][6] = 0
    ...
    J[15][13] = 0
    J[15][14] = 0
    J[15][15] = -0.00041*Cj - 0.0041*shCj
    J[15][16] = 0.300000000000000
    J[15][17] = 0
    J[15][18] = 0.200000000000000
    J[15][19] = 0
    J[15][20] = 0
    J[15][21] = 0
    J[15][22] = 0
    ...
    J[19][17] = 0
    J[19][18] = 0
    J[19][19] = -0.0005*B27 - 2.0e-8*ProduceBCjCj
    J[19][20] = 0
    J[19][21] = 0
    J[19][22] = -2.0e-8*HelperCCj
    J[19][23] = 0
    J[19][24] = 0
    J[19][25] = 0
    J[19][26] = 0
    ...
    J[22][17] = 0
    J[22][18] = 0
    J[22][19] = -2.0e-8*ProduceBCjCj
    J[22][20] = 0
    J[22][21] = 0
    J[22][22] = -0.0003*B21 - 2.0e-8*HelperCCj
    J[22][23] = 0
    J[22][24] = 0
    J[22][25] = 0
    J[22][26] = 0
    J[22][27] = 0
    J[22][28] = 0
    J[23][0] = -1.6e-5*ReactCBCj
    J[23][1] = 0
    J[23][2] = 0
    J[23][3] = 0
    J[23][4] = 0.0002*BackCB
    J[23][5] = 0
    J[23][6] = 0
    J[23][7] = 0
    J[23][8] = 0
    ...
    J[26][24] = 0
    J[26][25] = 0
    J[26][26] = -0.0026*BS24 - 2.0e-8*shProduceBCjCj
    J[26][27] = -2.0e-8*shHelperCCj
    J[26][28] = 0
    J[27][0] = 0
    J[27][1] = 0
    J[27][2] = 0.00024*BS24
    ...
    J[27][7] = 0
    J[27][8] = 0
    J[27][9] = -0.0016*shProduceBCjCj
    J[27][10] = 0.00024*shCj
    J[27][11] = 0
    J[27][12] = 0
    J[27][13] = 0
    J[27][14] = 0
    ...
    J[27][24] = 0
    J[27][25] = 0
    J[27][26] = -2.0e-8*shProduceBCjCj
    J[27][27] = -0.0016*BS18 - 2.0e-8*shHelperCCj
    J[27][28] = 0
    J[28][0] = 0
    J[28][1] = 0
    J[28][2] = -8.6e-5*shReactCBCj
    J[28][3] = 0
    J[28][4] = 0
    J[28][5] = 0
    J[28][6] = 0
...
def integrate(args, setlogger = False):
    ...
    svars = ["Cj", "Br", "shCj", "shBr", "B12", "B21", "B27", "B35", "B41", "BS18", "BS24", "BS32", "BS39", "BS44", "BackCB", "CancelC", "EC42", "EC52", "EC6", "HelperCCj", "O1", "O2", "ProduceBCjCj", "ReactCBCj", "dispC", "shBackCB", "shHelperCCj", "shProduceBCjCj", "shReactCBCj"]
