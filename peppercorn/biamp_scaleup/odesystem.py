...
def odesystem(p0, t0, r):
    Cj, Ck, Br, shCj, shCk, shBr, O1, O2, B12, B16, B21, B22, B27, B35, B41, BS18, BS19, BS24, BS32, BS39, BS44, BS9, BackCB, HelperCCk, ProduceBCjCk, ReactCBCj, shBackCB, shHelperCCk, shProduceBCjCk, shReactCBCj = p0
    if not r : r = rates


    dCjdt = 5.0e-5*B12*BackCB + 5.0e-5*B21*ProduceBCjCk - 5.0e-5*B27*Cj - 5.0e-5*Cj*ReactCBCj
    dCkdt = 5.0e-5*B16*BackCB + 5.0e-5*B27*HelperCCk - 5.0e-5*Ck*ReactCBCj + 2.0e-8*HelperCCk*ProduceBCjCk
    dBrdt = -5.0e-5*B12*Br - 5.0e-5*B16*Br
    dshCjdt = 0.001*BS18*shProduceBCjCk - 0.001*BS24*shCj + 0.001*BS39*shBackCB - 0.001*shCj*shReactCBCj
    dshCkdt = 0.001*BS24*shHelperCCk + 0.001*BS9*shBackCB - 0.001*shCk*shReactCBCj + 2.3557901941e-8*shHelperCCk*shProduceBCjCk
    dshBrdt = -0.001*BS39*shBr - 0.001*BS9*shBr
    dO1dt = 5.0e-6*O1*O2
    dO2dt = -5.0e-6*O1*O2
    dB12dt = -5.0e-5*B12*BackCB - 5.0e-5*B12*Br + 5.0e-5*Cj*ReactCBCj
    dB16dt = -5.0e-5*B16*BackCB - 5.0e-5*B16*Br + 5.0e-5*Ck*ReactCBCj
    dB21dt = 5.0e-5*B12*Br + 5.0e-5*B16*Br - 5.0e-5*B21*ProduceBCjCk + 5.0e-5*B27*Cj
    dB22dt = 5.0e-5*B16*Br
    dB27dt = 5.0e-5*B21*ProduceBCjCk - 5.0e-5*B27*Cj - 5.0e-5*B27*HelperCCk
    dB35dt = 5.0e-5*B27*HelperCCk
    dB41dt = 5.0e-5*B12*Br
    ...
    dBackCBdt = -5.0e-5*B12*BackCB - 5.0e-5*B16*BackCB + 5.0e-5*Cj*ReactCBCj + 5.0e-5*Ck*ReactCBCj
    dHelperCCkdt = -5.0e-5*B27*HelperCCk - 2.0e-8*HelperCCk*ProduceBCjCk
    dProduceBCjCkdt = -5.0e-5*B21*ProduceBCjCk + 5.0e-5*B27*Cj - 2.0e-8*HelperCCk*ProduceBCjCk
    dReactCBCjdt = 5.0e-5*B12*BackCB + 5.0e-5*B16*BackCB - 5.0e-5*Cj*ReactCBCj - 5.0e-5*Ck*ReactCBCj
    dshBackCBdt = -0.001*BS39*shBackCB - 0.001*BS9*shBackCB + 0.001*shCj*shReactCBCj + 0.001*shCk*shReactCBCj
    dshHelperCCkdt = -0.001*BS24*shHelperCCk - 2.3557901941e-8*shHelperCCk*shProduceBCjCk
    dshProduceBCjCkdt = -0.001*BS18*shProduceBCjCk + 0.001*BS24*shCj - 2.3557901941e-8*shHelperCCk*shProduceBCjCk
    dshReactCBCjdt = 0.001*BS39*shBackCB + 0.001*BS9*shBackCB - 0.001*shCj*shReactCBCj - 0.001*shCk*shReactCBCj
    return np.array([dCjdt, dCkdt, dBrdt, dshCjdt, dshCkdt, dshBrdt, dO1dt, dO2dt, dB12dt, dB16dt, dB21dt, dB22dt, dB27dt, dB35dt, dB41dt, dBS18dt, dBS19dt, dBS24dt, dBS32dt, dBS39dt, dBS44dt, dBS9dt, dBackCBdt, dHelperCCkdt, dProduceBCjCkdt, dReactCBCjdt, dshBackCBdt, dshHelperCCkdt, dshProduceBCjCkdt, dshReactCBCjdt])
...
def jacobian(p0, t0, r):
    ...
    J[0][0] = -5.0e-5*B27 - 5.0e-5*ReactCBCj
    J[0][1] = 0
    J[0][2] = 0
    J[0][3] = 0
    J[0][4] = 0
    ...
    J[1][21] = 0
    J[1][22] = 5.0e-5*B16
    J[1][23] = 5.0e-5*B27 + 2.0e-8*ProduceBCjCk
    ...
    J[3][1] = 0
    J[3][2] = 0
    J[3][3] = -0.001*BS24 - 0.001*shReactCBCj
    J[3][4] = 0
    J[3][5] = 0
    J[3][6] = 0
    J[3][7] = 0
    ...
    J[4][15] = 0
    J[4][16] = 0
    J[4][17] = 0.001*shHelperCCk
    J[4][18] = 0
    J[4][19] = 0
    J[4][20] = 0
    J[4][21] = 0.001*shBackCB
    J[4][22] = 0
    J[4][23] = 0
    J[4][24] = 0
    J[4][25] = 0
    J[4][26] = 0.001*BS9
    J[4][27] = 0.001*BS24 + 2.3557901941e-8*shProduceBCjCk
    J[4][28] = 2.3557901941e-8*shHelperCCk
    J[4][29] = -0.001*shCk
    J[5][0] = 0
    J[5][1] = 0
    J[5][2] = 0
    ...
    J[12][8] = 0
    J[12][9] = 0
    J[12][10] = 5.0e-5*ProduceBCjCk
    J[12][11] = 0
    J[12][12] = -5.0e-5*Cj - 5.0e-5*HelperCCk
    J[12][13] = 0
    J[12][14] = 0
    J[12][15] = 0
    J[12][16] = 0
    ...
    J[17][13] = 0
    J[17][14] = 0
    J[17][15] = 0.001*shProduceBCjCk
    J[17][16] = 0
    J[17][17] = -0.001*shCj - 0.001*shHelperCCk
    J[17][18] = 0
    J[17][19] = 0
    J[17][20] = 0
    J[17][21] = 0
    ...
    J[21][19] = 0
    J[21][20] = 0
    J[21][21] = -0.001*shBackCB - 0.001*shBr
    J[21][22] = 0
    J[21][23] = 0
    J[21][24] = 0
    J[21][25] = 0
    ...
    J[21][28] = 0
    J[21][29] = 0.001*shCk
    J[22][0] = 5.0e-5*ReactCBCj
    J[22][1] = 5.0e-5*ReactCBCj
    J[22][2] = 0
    J[22][3] = 0
    J[22][4] = 0
    J[22][5] = 0
    J[22][6] = 0
    J[22][7] = 0
    J[22][8] = -5.0e-5*BackCB
    J[22][9] = -5.0e-5*BackCB
    J[22][10] = 0
    J[22][11] = 0
    J[22][12] = 0
    J[22][13] = 0
    ...
    J[22][20] = 0
    J[22][21] = 0
    J[22][22] = -5.0e-5*B12 - 5.0e-5*B16
    J[22][23] = 0
    J[22][24] = 0
    J[22][25] = 5.0e-5*Cj + 5.0e-5*Ck
    J[22][26] = 0
    J[22][27] = 0
    J[22][28] = 0
    J[22][29] = 0
    ...
    J[23][21] = 0
    J[23][22] = 0
    J[23][23] = -5.0e-5*B27 - 2.0e-8*ProduceBCjCk
    J[23][24] = -2.0e-8*HelperCCk
    J[23][25] = 0
    J[23][26] = 0
    J[23][27] = 0
    J[23][28] = 0
    ...
    J[24][21] = 0
    J[24][22] = 0
    J[24][23] = -2.0e-8*ProduceBCjCk
    J[24][24] = -5.0e-5*B21 - 2.0e-8*HelperCCk
    J[24][25] = 0
    J[24][26] = 0
    J[24][27] = 0
    J[24][28] = 0
    J[24][29] = 0
    J[25][0] = -5.0e-5*ReactCBCj
    J[25][1] = -5.0e-5*ReactCBCj
    J[25][2] = 0
    J[25][3] = 0
    J[25][4] = 0
    J[25][5] = 0
    J[25][6] = 0
    J[25][7] = 0
    J[25][8] = 5.0e-5*BackCB
    J[25][9] = 5.0e-5*BackCB
    J[25][10] = 0
    J[25][11] = 0
    J[25][12] = 0
    J[25][13] = 0
    ...
    J[25][20] = 0
    J[25][21] = 0
    J[25][22] = 5.0e-5*B12 + 5.0e-5*B16
    J[25][23] = 0
    J[25][24] = 0
    J[25][25] = -5.0e-5*Cj - 5.0e-5*Ck
    J[25][26] = 0
    J[25][27] = 0
    J[25][28] = 0
    J[25][29] = 0
    ...
    J[26][17] = 0
    J[26][18] = 0
    J[26][19] = -0.001*shBackCB
    J[26][20] = 0
    J[26][21] = -0.001*shBackCB
    J[26][22] = 0
    J[26][23] = 0
    J[26][24] = 0
    J[26][25] = 0
    ...
    J[27][25] = 0
    J[27][26] = 0
    J[27][27] = -0.001*BS24 - 2.3557901941e-8*shProduceBCjCk
    J[27][28] = -2.3557901941e-8*shHelperCCk
    J[27][29] = 0
    J[28][0] = 0
    J[28][1] = 0
    J[28][2] = 0
    ...
    J[28][25] = 0
    J[28][26] = 0
    J[28][27] = -2.3557901941e-8*shProduceBCjCk
    J[28][28] = -0.001*BS18 - 2.3557901941e-8*shHelperCCk
    J[28][29] = 0
    J[29][0] = 0
    J[29][1] = 0
    J[29][2] = 0
    J[29][3] = -0.001*shReactCBCj
    J[29][4] = -0.001*shReactCBCj
    J[29][5] = 0
    J[29][6] = 0
    J[29][7] = 0
    J[29][8] = 0
    ...
    J[29][17] = 0
    J[29][18] = 0
    J[29][19] = 0.001*shBackCB
    J[29][20] = 0
    J[29][21] = 0.001*shBackCB
    J[29][22] = 0
    J[29][23] = 0
    J[29][24] = 0
    J[29][25] = 0
...
def integrate(args, setlogger = False):
    ...
    svars = ["Cj", "Ck", "Br", "shCj", "shCk", "shBr", "O1", "O2", "B12", "B16", "B21", "B22", "B27", "B35", "B41", "BS18", "BS19", "BS24", "BS32", "BS39", "BS44", "BS9", "BackCB", "HelperCCk", "ProduceBCjCk", "ReactCBCj", "shBackCB", "shHelperCCk", "shProduceBCjCk", "shReactCBCj"]
