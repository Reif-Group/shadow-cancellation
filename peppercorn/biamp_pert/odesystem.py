...
def odesystem(p0, t0, r):
    Cj, Ck, Br, shCj, shCk, shBr, B12, B16, B21, B22, B27, B35, B41, BS18, BS19, BS24, BS32, BS39, BS44, BS9, BackCB, HelperCCk, O1, O2, ProduceBCjCk, ReactCBCj, shBackCB, shHelperCCk, shProduceBCjCk, shReactCBCj = p0
    if not r : r = rates
...
def integrate(args, setlogger = False):
    ...
    svars = ["Cj", "Ck", "Br", "shCj", "shCk", "shBr", "B12", "B16", "B21", "B22", "B27", "B35", "B41", "BS18", "BS19", "BS24", "BS32", "BS39", "BS44", "BS9", "BackCB", "HelperCCk", "O1", "O2", "ProduceBCjCk", "ReactCBCj", "shBackCB", "shHelperCCk", "shProduceBCjCk", "shReactCBCj"]
