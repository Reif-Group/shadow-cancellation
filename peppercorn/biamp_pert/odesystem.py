...
def odesystem(p0, t0, r):
    ...
    dCjdt = 0.0001*B12*BackCB + 0.0001*B21*ProduceBCjCk - 0.0001*B27*Cj - 0.0041*CancelC*Cj - 0.0041*Cj*EC3 - 0.0041*Cj*EC6 - 8.6e-5*Cj*ReactCBCj + 0.3*EC42
    dCkdt = 0.0001*B16*BackCB + 0.0001*B27*HelperCCk - 0.0041*CancelC*Ck - 0.0041*Ck*EC3 - 0.0041*Ck*EC6 - 8.6e-5*Ck*ReactCBCj + 0.3*EC8 + 2.0e-8*HelperCCk*ProduceBCjCk
    dBrdt = -0.0001*B12*Br - 0.0001*B16*Br
    dshCjdt = 0.001*BS18*shProduceBCjCk - 0.001*BS24*shCj + 0.001*BS39*shBackCB - 0.0041*CancelC*shCj - 0.0041*EC42*shCj + 0.2*EC6 - 0.0041*EC8*shCj - 0.00086*shCj*shReactCBCj
    dshCkdt = 0.001*BS24*shHelperCCk + 0.001*BS9*shBackCB - 0.0041*CancelC*shCk + 0.2*EC3 - 0.0041*EC42*shCk - 0.0041*EC8*shCk - 0.00086*shCk*shReactCBCj + 2.0e-8*shHelperCCk*shProduceBCjCk
...
def jacobian(p0, t0, r):
    ...
    J[0][0] = -0.0001*B27 - 0.0041*CancelC - 0.0041*EC3 - 0.0041*EC6 - 8.6e-5*ReactCBCj
    J[0][1] = 0
    J[0][2] = 0
    J[0][3] = 0
    J[0][4] = 0
    ...
    J[1][30] = 0.0001*B27 + 2.0e-8*ProduceBCjCk
    J[1][31] = 0
    J[1][32] = 0
    ...
    J[3][1] = 0
    J[3][2] = 0
    J[3][3] = -0.001*BS24 - 0.0041*CancelC - 0.0041*EC42 - 0.0041*EC8 - 0.00086*shReactCBCj
    J[3][4] = 0
    J[3][5] = 0
    J[3][6] = -0.0041*shCj
    J[3][7] = 0
    ...
    J[4][35] = 0
    J[4][36] = 0.001*BS9
    J[4][37] = 0.001*BS24 + 2.0e-8*shProduceBCjCk
    ...
    J[30][28] = 0
    J[30][29] = 0
    J[30][30] = -0.0001*B27 - 2.0e-8*ProduceBCjCk
    J[30][31] = 0
    J[30][32] = 0
    ...
    J[33][31] = 0
    J[33][32] = 0
    J[33][33] = -0.0001*B21 - 2.0e-8*HelperCCk
    J[33][34] = 0
    J[33][35] = 0
    J[33][36] = 0
    J[33][37] = 0
