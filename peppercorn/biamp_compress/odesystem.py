...
def odesystem(p0, t0, r):
    Cj, Br, shCj, shBr, O1, O2, HelperCCj, B12, B21, B27, B35, B41, BS18, BS24, BS32, BS39, BS44, BackCB, CancelC, EC42, EC52, EC6, ProduceBCjCj, ReactCBCj, dispC, shBackCB, shHelperCCj, shProduceBCjCj, shReactCBCj = p0
    if not r : r = rates


    dCjdt = 0.001*B12*BackCB + 0.0016*B21*ProduceBCjCj - 0.00024*B27*Cj + 0.0026*B27*HelperCCj - 0.00041*CancelC*Cj - 0.0041*Cj*EC6 - 8.6e-5*Cj*ReactCBCj + 0.3*EC42 + 2.0e-8*HelperCCj*ProduceBCjCj
    dBrdt = -0.0003*B12*Br
    dshCjdt = 0.005*BS18*shProduceBCjCj - 0.0024*BS24*shCj + 0.005*BS24*shHelperCCj + 0.005*BS39*shBackCB - 0.0041*CancelC*shCj - 0.0041*EC42*shCj + 0.2*EC6 - 0.00086*shCj*shReactCBCj + 2.0e-8*shHelperCCj*shProduceBCjCj
    dshBrdt = -0.003*BS39*shBr
    dO1dt = 2.2e-5*O1*O2
    dO2dt = -2.2e-5*O1*O2
    dHelperCCjdt = -0.0026*B27*HelperCCj - 2.0e-8*HelperCCj*ProduceBCjCj
    dB12dt = -0.001*B12*BackCB - 0.0003*B12*Br + 8.6e-5*Cj*ReactCBCj
    dB21dt = 0.0003*B12*Br - 0.0016*B21*ProduceBCjCj + 0.00024*B27*Cj
    dB27dt = 0.0016*B21*ProduceBCjCj - 0.00024*B27*Cj - 0.0026*B27*HelperCCj
    dB35dt = 0.0026*B27*HelperCCj
    dB41dt = 0.0003*B12*Br
    dBS18dt = -0.005*BS18*shProduceBCjCj + 0.0024*BS24*shCj + 0.003*BS39*shBr
    dBS24dt = 0.005*BS18*shProduceBCjCj - 0.0024*BS24*shCj - 0.005*BS24*shHelperCCj
    dBS32dt = 0.005*BS24*shHelperCCj
    dBS39dt = -0.005*BS39*shBackCB - 0.003*BS39*shBr + 0.00086*shCj*shReactCBCj
    dBS44dt = 0.003*BS39*shBr
    dBackCBdt = -0.001*B12*BackCB + 8.6e-5*Cj*ReactCBCj
    ...
    dProduceBCjCjdt = -0.0016*B21*ProduceBCjCj + 0.00024*B27*Cj - 2.0e-8*HelperCCj*ProduceBCjCj
    dReactCBCjdt = 0.001*B12*BackCB - 8.6e-5*Cj*ReactCBCj
    ddispCdt = 0.0041*Cj*EC6 + 0.0041*EC42*shCj
    dshBackCBdt = -0.005*BS39*shBackCB + 0.00086*shCj*shReactCBCj
    dshHelperCCjdt = -0.005*BS24*shHelperCCj - 2.0e-8*shHelperCCj*shProduceBCjCj
    dshProduceBCjCjdt = -0.005*BS18*shProduceBCjCj + 0.0024*BS24*shCj - 2.0e-8*shHelperCCj*shProduceBCjCj
    dshReactCBCjdt = 0.005*BS39*shBackCB - 0.00086*shCj*shReactCBCj
    return np.array([dCjdt, dBrdt, dshCjdt, dshBrdt, dO1dt, dO2dt, dHelperCCjdt, dB12dt, dB21dt, dB27dt, dB35dt, dB41dt, dBS18dt, dBS24dt, dBS32dt, dBS39dt, dBS44dt, dBackCBdt, dCancelCdt, dEC42dt, dEC52dt, dEC6dt, dProduceBCjCjdt, dReactCBCjdt, ddispCdt, dshBackCBdt, dshHelperCCjdt, dshProduceBCjCjdt, dshReactCBCjdt])
...
def jacobian(p0, t0, r):
    ...
    J[0][0] = -0.00024*B27 - 0.00041*CancelC - 0.0041*EC6 - 8.6e-5*ReactCBCj
    J[0][1] = 0
    J[0][2] = 0
    J[0][3] = 0
    J[0][4] = 0
    J[0][5] = 0
    J[0][6] = 0.0026*B27 + 2.0e-8*ProduceBCjCj
    J[0][7] = 0.001*BackCB
    J[0][8] = 0.0016*ProduceBCjCj
    J[0][9] = -0.00024*Cj + 0.0026*HelperCCj
    J[0][10] = 0
    J[0][11] = 0
    J[0][12] = 0
    J[0][13] = 0
    ...
    J[0][17] = 0.001*B12
    J[0][18] = -0.00041*Cj
    J[0][19] = 0.300000000000000
    J[0][20] = 0
    J[0][21] = -0.0041*Cj
    J[0][22] = 0.0016*B21 + 2.0e-8*HelperCCj
    J[0][23] = -8.6e-5*Cj
    J[0][24] = 0
    J[0][25] = 0
    J[0][26] = 0
    ...
    J[2][0] = 0
    J[2][1] = 0
    J[2][2] = -0.0024*BS24 - 0.0041*CancelC - 0.0041*EC42 - 0.00086*shReactCBCj
    J[2][3] = 0
    J[2][4] = 0
    J[2][5] = 0
    J[2][6] = 0
    ...
    J[2][10] = 0
    J[2][11] = 0
    J[2][12] = 0.005*shProduceBCjCj
    J[2][13] = -0.0024*shCj + 0.005*shHelperCCj
    J[2][14] = 0
    J[2][15] = 0.005*shBackCB
    J[2][16] = 0
    J[2][17] = 0
    J[2][18] = -0.0041*shCj
    J[2][19] = -0.0041*shCj
    J[2][20] = 0
    J[2][21] = 0.200000000000000
    J[2][22] = 0
    J[2][23] = 0
    J[2][24] = 0
    J[2][25] = 0.005*BS39
    J[2][26] = 0.005*BS24 + 2.0e-8*shProduceBCjCj
    J[2][27] = 0.005*BS18 + 2.0e-8*shHelperCCj
    J[2][28] = -0.00086*shCj
    J[3][0] = 0
    J[3][1] = 0
    J[3][2] = 0
    ...
    J[6][4] = 0
    J[6][5] = 0
    J[6][6] = -0.0026*B27 - 2.0e-8*ProduceBCjCj
    J[6][7] = 0
    J[6][8] = 0
    J[6][9] = -0.0026*HelperCCj
    J[6][10] = 0
    J[6][11] = 0
    J[6][12] = 0
    J[6][13] = 0
    ...
    J[9][6] = -0.0026*B27
    J[9][7] = 0
    J[9][8] = 0.0016*ProduceBCjCj
    J[9][9] = -0.00024*Cj - 0.0026*HelperCCj
    J[9][10] = 0
    J[9][11] = 0
    J[9][12] = 0
    J[9][13] = 0
    ...
    J[13][10] = 0
    J[13][11] = 0
    J[13][12] = 0.005*shProduceBCjCj
    J[13][13] = -0.0024*shCj - 0.005*shHelperCCj
    J[13][14] = 0
    J[13][15] = 0
    J[13][16] = 0
    J[13][17] = 0
    ...
    J[15][13] = 0
    J[15][14] = 0
    J[15][15] = -0.005*shBackCB - 0.003*shBr
    J[15][16] = 0
    J[15][17] = 0
    J[15][18] = 0
    J[15][19] = 0
    ...
    J[18][16] = 0
    J[18][17] = 0
    J[18][18] = -0.00041*Cj - 0.0041*shCj
    J[18][19] = 0.300000000000000
    J[18][20] = 0
    J[18][21] = 0.200000000000000
    J[18][22] = 0
    J[18][23] = 0
    J[18][24] = 0
    J[18][25] = 0
    ...
    J[22][4] = 0
    J[22][5] = 0
    J[22][6] = -2.0e-8*ProduceBCjCj
    J[22][7] = 0
    J[22][8] = -0.0016*ProduceBCjCj
    J[22][9] = 0.00024*Cj
    J[22][10] = 0
    J[22][11] = 0
    J[22][12] = 0
    ...
    J[22][20] = 0
    J[22][21] = 0
    J[22][22] = -0.0016*B21 - 2.0e-8*HelperCCj
    J[22][23] = 0
    J[22][24] = 0
    J[22][25] = 0
    J[22][26] = 0
    ...
    J[26][24] = 0
    J[26][25] = 0
    J[26][26] = -0.005*BS24 - 2.0e-8*shProduceBCjCj
    ...
    J[27][27] = -0.005*BS18 - 2.0e-8*shHelperCCj
    J[27][28] = 0
    J[28][0] = 0
    J[28][1] = 0
    J[28][2] = -0.00086*shReactCBCj
    J[28][3] = 0
    J[28][4] = 0
    J[28][5] = 0
    J[28][6] = 0
...
def integrate(args, setlogger = False):
    ...
    svars = ["Cj", "Br", "shCj", "shBr", "O1", "O2", "HelperCCj", "B12", "B21", "B27", "B35", "B41", "BS18", "BS24", "BS32", "BS39", "BS44", "BackCB", "CancelC", "EC42", "EC52", "EC6", "ProduceBCjCj", "ReactCBCj", "dispC", "shBackCB", "shHelperCCj", "shProduceBCjCj", "shReactCBCj"]
